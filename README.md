...
Cuando se crea `mysql_data` por primera vez, MySQL carga
`database/reference/db.sql`. Para cargarlo de nuevo hay que recrear el volumen
con `docker compose down -v`; esa operación elimina los datos locales.
